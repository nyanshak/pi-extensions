# @nyanshak/pi-web-dashboard

> **Fork of** [espennilsen/pi — pi-web-dashboard](https://github.com/espennilsen/pi/tree/main/extensions/pi-web-dashboard) · MIT Licensed · Originally by Espen Nilsen
...
```bash
pi install npm:@nyanshak/pi-web-dashboard
```
