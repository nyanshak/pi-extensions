# @nyanshak/pi-webserver

> **Fork of** [espennilsen/pi — pi-webserver](https://github.com/espennilsen/pi/tree/main/extensions/pi-webserver) · MIT Licensed · Originally by Espen Nilsen
...
```bash
pi install npm:@nyanshak/pi-webserver
```
